...
{   
    ...
    // update user data
    $result = mysqli_query($konek, "UPDATE barang_toko SET nama_barang='$nama_barang',harga_barang='$harga_barang',stok_barang='$stok_barang' WHERE id_barang=$id");
...
$result = mysqli_query($konek, "SELECT * FROM barang_toko WHERE id_barang=$id");
...
<html>
<head>
 <title>Aplikasi Toko DIDIK</title>
</head>
<body style="font-family:arial">
 <center><h1>Aplikasi <br /> Toko DIDIK</h1></center>
 <hr />
